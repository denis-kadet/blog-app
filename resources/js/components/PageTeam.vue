                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-christopher-walken.jpg">
                        </div>
                        <div class="mc-description">
                            He has appeared in more than 100 films and television shows, including The Deer Hunter, Annie
                            Hall, The Prophecy trilogy, The Dogs of War ...
                        </div>
                    </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Pink">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-sean-penn.jpg">
                        </div>
                        <div class="mc-description">
                            He has won two Academy Awards, for his roles in the mystery drama Mystic River (2003) and the
                            biopic Milk (2008). Penn began his acting career in television with a brief appearance in a 1974
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Purple">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-clint-eastwood.jpg">
                        </div>
                        <div class="mc-description">
                            He rose to international fame with his role as the Man with No Name in Sergio Leone's Dollars
                            trilogy of spaghetti Westerns during the 1960s ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
                        <i class="fa fa-bars"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Deep-Purple">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-dustin-hoffman.jpg">
                        </div>
                        <div class="mc-description">
                            He has been known for his versatile portrayals of antiheroes and vulnerable characters.[3] He
                            won the Academy Award for Kramer vs. Kramer in 1979 ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
                        <i class="fa fa-bars"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Indigo">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-edward-norton.jpg">
                        </div>
                        <div class="mc-description">
                            He has been nominated for three Academy Awards for his work in the films Primal Fear, American
                            History X and Birdman. He also starred in other roles ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
                        <i class="fa fa-bars"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Blue">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-michael-caine.jpg">
                        </div>
                        <div class="mc-description">
                            English actor and author. Renowned for his distinctive working class cockney accent, Caine has
                            appeared in over 115 films and is regarded as a British ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
                        <i class="fa fa-bars"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Light-Blue">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-harvey-keitel.jpg">
                        </div>
                        <div class="mc-description">
                            Some of his most notable starring roles were in Martin Scorsese's Mean Streets and Taxi Driver,
                            Ridley Scott's The Duellists and Thelma & Louise, Quentin Tarantino ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
                        <i class="fa fa-bars"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Cyan">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-jack-nicholson.jpg">
                        </div>
                        <div class="mc-description">
                            Throughout his career, Nicholson has portrayed unique and challenging roles, many of which
                            include dark portrayals of excitable, neurotic and psychopathic characters ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
                        <i class="fa fa-bars"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Teal">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-jeff-bridges.jpg">
                        </div>
                        <div class="mc-description">
                            He comes from a well-known acting family and began his televised acting in 1958 as a child with
                            his father, Lloyd Bridges, and brother, Beau, on television's Sea Hunt ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
                        <i class="fa fa-bars"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Green">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-joaquin-phoenix.jpg">
                        </div>
                        <div class="mc-description">
                            is an American actor, producer, music video director, musician and activist. For his work as an
                            artist, Phoenix has received a Grammy Award, a Golden Globe Award and three Academy ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
                        <i class="fa fa-bars"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Light-Green">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-tom-hanks.jpg">
                        </div>
                        <div class="mc-description">
                            He is known for his roles in Big (1988), Philadelphia (1993), Forrest Gump (1994), Apollo 13
                            (1995), Saving Private Ryan, You've Got Mail (both 1998), The Green Mile (1999), Cast Away
                            (2000) ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Lime">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-philip-seymour-hoffman.jpg">
                        </div>
                        <div class="mc-description">
                            Best known for his distinctive supporting and character roles – typically lowlifes, bullies, and
                            misfits – Hoffman was a regular presence in films from the early 1990s until his death at age
                            46.
                        </div>
                    </div>
                    <a class="mc-btn-action">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Yellow">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-paul-newman.jpg">
                        </div>
                        <div class="mc-description">
                            He won numerous awards, including an Academy Award for his performance in the 1986 film The
                            Color of Money,[3] a BAFTA Award, a Screen Actors Guild Award, a Cannes Film Festival Award, an
                            Emmy Award ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Amber">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-marlon-brando.jpg">
                        </div>
                        <div class="mc-description">
                            He is hailed for bringing a gripping realism to film acting, and is frequently cited as the
                            greatest and most influential actor of all time.[2] A cultural icon, Brando is most famous for
                            his Academy ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Orange">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-kevin-spacey.jpg">
                        </div>
                        <div class="mc-description">
                            He began his career as a stage actor during the 1980s, before being cast in supporting roles in
                            film and television. He gained critical acclaim in the early 1990s, culminating in his first
                            Academy Award ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Deep-Orange">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-robert-de-niro.jpg">
                        </div>
                        <div class="mc-description">
                            His first major film roles were in the sports drama Bang the Drum Slowly (1973) and Martin
                            Scorsese's crime film Mean Streets (1973). In 1974, after being turned down for the role of
                            Sonny Corleone in the crime ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
                        <i class="fa fa-bars"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Brown">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-steve-mcqueen.jpg">
                        </div>
                        <div class="mc-description">
                            Called "The King of Cool", his "anti-hero" persona, developed at the height of the Vietnam
                            War-era counterculture, made him a top box-office draw of the 1960s and 1970s. McQueen received
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Grey">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-rugter-hauer.jpg">
                        </div>
                        <div class="mc-description">
                            Blonde, blue-eyed, tall and handsome Dutch actor Rutger Hauer has an international reputation
                            for playing everything from romantic leads to action heroes to sinister villains. Hauer was born
                            in Breukelen, a town in the province ...
                        </div>
                    </div>
                    <a class="mc-btn-action">
                        <i class="fa fa-bars"></i>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <article class="material-card Blue-Grey">
                    ...
                    <div class="mc-content">
                        <div class="img-container">
                            <img class="img-responsive"
                                src="https://gomnam1336.github.io/FrontEndSite/Bootstrap_Grids/Material_Design_Responsive_Grid/thumb-morgan-freeman.jpg">
                        </div>
                        <div class="mc-description">
                            Freeman has received Academy Award nominations for his performances in Street Smart, Driving
...
export default {
    ...
    created() {
        console.log('Component PageTeam mounted.')
    }
}
</script>
